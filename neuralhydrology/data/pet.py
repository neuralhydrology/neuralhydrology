...
@njit
def get_priestley_taylor_pet(t_min: np.ndarray, t_max: np.ndarray, s_rad: np.ndarray, lat: float,
                             elev: float, doy: np.ndarray) -> np.ndarray:
...
@njit
def get_extraterra_rad(lat: float, sol_dec: np.ndarray, sha: np.ndarray,
                       ird: np.ndarray) -> np.ndarray:
...
@njit
def get_net_outgoing_lw_rad(t_min: np.ndarray, t_max: np.ndarray, s_rad: np.ndarray,
                            cs_rad: np.ndarray, a_vp: np.ndarray) -> np.ndarray:
